...
<?php output_main_body_and_container("checkout");?>
                  ...
                  <div class="box-row">
                    ...
                    <!-- div container for card information -->
                    <div class="checkout-details">

                      <h3>Payment</h3>
                      <label for="Cards">Accepted Cards</label>

                      <!-- contains icons of different payment card companies -->
                      ...
                      <input type="text" id="cardname" name="cardname" placeholder="Aryan Gangoosirdar">
                      <label for="cardnumber">Credit card number</label>
                      <input type="text" id="cardnumber" name="cardnumber" placeholder="1234-5678-9123-4567">
                      <label for="expiry-month">Expiry Month</label>
                      <input type="text" id="expiry-month" name="expiry-month" placeholder="Ex: September">
                      
                      <!-- div container for further card info -->
                      <div class="box-row">
                            <div class="checkout-details">
                                <label for="expiry-year">Expiry Year</label>
                                <input type="text" id="expiry-year" name="expiry-year" placeholder="2023">
                            </div>
                            <div class="checkout-details">
                                <label for="card-verification">CVV</label>
                                <input type="text" id="card-verification" name="card-verification" placeholder="732">
                            </div>
                      </div>
