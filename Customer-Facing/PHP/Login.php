                ...
                <div id="auth_login" class="auth-box">
                  <!-- form for data input -->
                    <form class="auth-form" action="#Login">
                      ...
                      <div class="column-box">
                        <!-- Data entry fields -->
                        <input type="text" id="auth_login_username" name="_username" value="" placeholder="Username" required="required" autocorrect="off" spellcheck="false" autocomplete="off" class="text focus-field">
                      </div>
            
                      <div class="column-box">
                        <input type="password" id="auth_login_password" name="_password" placeholder="Password" autocomplete="off" required="required" class="text">
                      </div>
            
                      <div class="column-box">
                        <!-- form submit button -->
                        <input type="submit" id="login_submit" class="btn-gold" name="_submit" value="Sign in">
                      </div>
