                ...
                <div id="auth_register" class="auth-box">
                    ...
                    <form name="register-form">
                        <div id="registration_form" ng-non-bindable="true">
                            ...
                            <div class="col">
                                <input onkeyup="enable_username()" autocomplete="off" type="text" id="registration_form_username" name="registration_form[username]" required="required" class="text form-control" placeholder="Username">        
                            </div>
                            <div class="col">
                            ...
                            <div class="col-1">
                                <input onkeyup="check_password()" type="password" id="registration_form_plainPassword" name="registration_form[plainPassword]" required="required" class="text form-control" placeholder="Password">        
                            </div>
                            <!-- form submit button -->
                            
                            <button onclick="readData()" type="submit" id="registration_form_submit" name="registration_form[submit]" class="btn-gold">Create Your Account</button>
...
<script src="http://localhost/Customer-Facing/JavaScript/register.js"></script>
<?php output_footer() ;?>